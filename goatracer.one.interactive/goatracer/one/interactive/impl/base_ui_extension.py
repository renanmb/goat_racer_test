...
from isaacsim.gui.components.ui_utils import btn_builder, get_style, setup_ui_headers, str_builder, combo_cb_str_builder
...
class BaseSampleUITemplate:
    ...
    def build_default_frame(self):
        ...
        with self._controls_frame:
            with ui.VStack(style=get_style(), spacing=5, height=0):
                ...
                self._buttons["Filepath"] = str_builder(**dict) # Returns model of Stringfield
                # self._buttons["Filepath"] = combo_cb_str_builder(**dict) # Returns (cb_model, str_field_model)
    ...
    def _on_load_world(self):
        async def _on_load_world_async():
            _filepath = self._buttons["Filepath"].get_value_as_string()
            self._sample._relative_path = _filepath
